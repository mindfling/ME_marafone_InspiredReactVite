...
export const Top = () => (
  <div className={s.top}>
    <Container className={cn(s.topContainer, 'header__container')}>
      <a class={cn(s.topLink, s.topPhone)} href="tel:89001231234" title="Office phone">8&nbsp;930&nbsp;490&nbsp;26&nbsp;20</a>
      <a className={cn(s.topLink, s.topLogo)} href="#" title='logo'>
        <img class={cn(s.topLogo)} src={logo} alt="Logo Inspired"></img>
      </a>
      <div class={cn(s.topNavigation, 'header__navigation')}>
        <ul class={s.topNavList}>
